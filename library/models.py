...
class NovelVote(models.Model):
    ...
    session_key = models.CharField(max_length=40)  # Identitas user tanpa login
    score = models.IntegerField()
    created_at = models.DateTimeField(auto_now_add=True)

    class Meta:
        unique_together = ('novel', 'session_key') # Satu browser cuma bisa vote 1x per novel
